...
<html lang="en">
    <head>
        ...
        <title>Admin Login | BEing Human Film Festival</title>
                    ...
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="form-box">
	                       ...
	                       <div class="form-bottom">
                                <form name="form" action="<?php echo htmlspecialchars ('php/loginProcessing.php');?>" method="post" class="login-form">
                                    <div class="form-group">
                                        <label class="sr-only" for="username">Username</label>
                                        <input type="text" name="username" placeholder="Username..." class="form-username form-control" id="username" value="<?php if (isset($_SESSION['username'])) print $_SESSION['username'];?>">
                                    </div>
                                    <div class="form-group">
