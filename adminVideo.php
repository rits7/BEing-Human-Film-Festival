...
<html lang="en">
    <head>
        ...
        <title>Video Control Panel | BEing Human Film Festival</title>
    ...
    <body class="admin">
        ...
        <div class="container-fluid col-10 col-md-9 col-lg-8 page-contents p-4">
            ...
            <form class="w-75 mt-4" method="post" action="<?php echo htmlspecialchars ('php/adminVideoProcessing.php');?>">
                <div class="form-group mt-2">
                    <label for="formVideoTitle">Video Title:</label>
                    <input type="text" class="form-control" id="formVideoTitle" name="videoTitle" value="<?php if (isset($_SESSION['videoTitle'])) print $_SESSION['videoTitle'];?>" />
                </div>
                <div class="form-group mt-2">
                    <label for="formVideoCreator">Video Creator:</label>
                    <input type="text" class="form-control" id="formVideoCreator" name="videoCreator" value="<?php if (isset($_SESSION['videoCreator'])) print $_SESSION['videoCreator'];?>" />
                </div>
                <div class="form-group mt-2">
                    <label for="formVideoSchool">Video School:</label>
                    <input type="text" class="form-control" id="fromVideoSchool" name="videoSchool" value="<?php if (isset($_SESSION['videoSchool'])) print $_SESSION['videoSchool'];?>" />
                </div>
                <div class="form-group mt-2">
                    <label for="formVideoCountry">Video Country:</label>
                    <input type="text" class="form-control" id="formVideoCountry" name="videoCountry" value="<?php if (isset($_SESSION['videoCountry'])) print $_SESSION['videoCountry'];?>" />
                </div>
                <div class="form-group mt-2">
                    <label for="formVideoLink">Youtube Video ID:</label>
                    <input type="text" class="form-control" id="formVideoLink" name="videoLink" value="<?php if (isset($_SESSION['videoLink'])) print $_SESSION['videoLink'];?>" />
                    <small id="linkHelp" class="form-text text-muted">YouTube video ID only</small>
                </div>
                <div class="form-group mt-2">
                    <label for="formVideoImage">Video Image:</label>
                    <input type="text" class="form-control" id="formVideoTitle" name="videoImage" value="<?php if (isset($_SESSION['videoImage'])) print $_SESSION['videoImage'];?>" />
                    <small id="imageHelp" class="form-text text-muted">Name of file plus extension from "Images" folder</small>
                </div>
                <div class="form-group mt-2">
                    <label for="formVideoYear">Video Year:</label>
                    <input type="text" class="form-control" id="formVideoYear" name="videoYear" value="<?php if (isset($_SESSION['videoYear'])) print $_SESSION['videoYear'];?>" />
                </div>
                <div class="form-group mt-2">
                    <label for="formVideoID">Video ID:</label>
                    <input type="text" class="form-control" id="formVideoID" name="videoID" value="<?php if (isset($_SESSION['videoID'])) print $_SESSION['videoID'];?>" />
            ...
            <form class="w-100 view-all w-75 mt-2" method="post" action="<?php echo htmlspecialchars ($_SERVER['PHP_SELF']);?>">
                ...
                <?php
                    ...
                    if(isset($_POST{'viewAll'}))
                    {
                        ...
                        while ($row = mysqli_fetch_array($result))
                        {
                            print"<tbody>";
                            print"<tr>";
                            print"<td class='p-1'><a href='php/adminVideoProcessing.php?VideoID=$row[0]'>$row[0]</a></td>";
                            print"<td class='p-1'>$row[1]</td>";
                            print"<td class='p-1'>$row[2]</td>";
                            print"<td class='p-1'>$row[3]</td>";
                            print"<td class='p-1'>$row[4]</td>";
                            print"<td class='p-1'>$row[5]</td>";
                            print"<td class='p-1'>$row[6]</td>";
                            print"<td class='p-1'>$row[7]</td>";
                            print "</tr>";
                            print"</tbody>";
                        }
                        print "</table>";
